  ...
  return (
    <li className="group relative isolate overflow-hidden rounded-xl border border-slate-200/80 bg-white/50 shadow-sm backdrop-blur-sm transition-shadow duration-300 hover:shadow-md">
      ...
      <div className="relative z-10 grid gap-6 px-5 py-8 sm:grid-cols-[minmax(0,280px)_1fr] sm:gap-10 sm:px-6 sm:py-10 lg:grid-cols-[minmax(0,320px)_1fr] lg:gap-16">
        <h3 className="font-hero text-left text-xl font-bold leading-snug text-[#1a1a1a] transition-colors duration-300 group-hover:text-white sm:text-2xl sm:leading-tight">
          {title}
        </h3>
        <p className="text-left text-base leading-[1.6] text-[#555555] transition-colors duration-300 group-hover:text-slate-200 sm:text-lg sm:leading-relaxed">
          {description}
        </p>
      </div>
    </li>
